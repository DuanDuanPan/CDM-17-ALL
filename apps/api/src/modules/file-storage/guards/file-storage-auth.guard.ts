 ...
 *
 * Mirrors DataManagementAuthGuard behavior:
 * - In non-production: allow requests (developer-friendly)
 * - In production: require either `x-user-id` or `Authorization` header
 *
 * TODO: Replace with real auth + graph-level authorization.
 */
@Injectable()
export class FileStorageAuthGuard implements CanActivate {
