 ...
 * 
 * Migrated from apps/api/src/modules/data-management/node-data-link.service.ts
 */
...
export class NodeDataLinkService {
    ...
    private toAssetResponse(asset: PrismaDataAsset & { folder?: PrismaDataFolder | null }): DataAssetWithFolder {
        // Story 10.8 Code Review: Align with DataAssetService.toAssetResponse()
        // For IMAGE format with storagePath, use FileStorageService thumbnail endpoint
        ...
        return {
            ...
            // Story 10.8 Code Review: Map storagePath (fileId) to accessible URL for frontend
