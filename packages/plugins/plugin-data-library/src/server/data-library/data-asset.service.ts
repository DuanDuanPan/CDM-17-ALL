 ...
 * 
 * KEY CHANGE for plugin migration:
 * - FileStorageService → IFileStorageService via @Inject(FILE_STORAGE_SERVICE)
 * - FileOwnerType imported from @cdm/database (not apps/api)
 * 
 * Migrated from apps/api/src/modules/data-management/data-asset.service.ts
 */
 ...
 * Uses shared constant from @cdm/database for type safety
 */
